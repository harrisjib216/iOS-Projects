...
struct ContentView: View {
    ...
    @State private var usersIncorrectChoice = ""
...
//                .ignoresSafeArea()
        ...
        .alert("Oops", isPresented: $showIncorrectAlert) {
            Button("Continue", action: nextQuestion)
        } message: {
            Text("Wrong that was the flag of: \(usersIncorrectChoice)")
        }
    }
    ...
    func onFlagTapped(_ index: Int) {
        if index == correctAnswer {
            ...
            score -= 0.5
            usersIncorrectChoice = countries[index]
